...
export const metadata: Metadata = {
  title: "About Olympus – The HR League | µLearn",
  description:
    "Learn about Olympus, a pioneering initiative by the HR Interest Group of µLearn to develop industry-ready HR and management leaders.",
};

const objectives = [
  {
    iconName: "Users",
    title: "Build a Management Community",
    description:
      "Create a dedicated ecosystem for future HR and management leaders through experiential learning.",
  },
  {
    iconName: "Target",
    title: "Integrate Institutions",
    description:
      "Connect academic institutions into collaborative learning networks for practical skill development.",
  },
  {
    iconName: "Heart",
    title: "Hands-on HR Exposure",
    description:
      "Provide real-world HR scenarios that test ethical judgment and decision-making under pressure.",
  },
  {
    iconName: "Shield",
    title: "Encourage Ethical Leadership",
    description:
      "Foster leaders who make people-first decisions with integrity, empathy, and strategic clarity.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold font-heading text-foreground leading-tight mb-6">
                About Olympus
                <br />
                <span className="text-primary">The HR League</span>
              </h1>
              <p className="text-lg md:text-xl text-foreground/60 leading-relaxed mb-8 max-w-xl">
                A pioneering initiative by the HR Interest Group of µLearn, 
                built to create a dedicated ecosystem for future HR and 
                management leaders through experiential learning.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-card rounded-3xl p-8 md:p-12 shadow-2xl border border-border">
                ...
                <p className="text-card-foreground/70 leading-relaxed">
                  To develop industry-ready professionals who lead with integrity, 
                  empathy, and strategic clarity. We envision a generation of leaders 
                  equipped to navigate complex human dynamics and organizational 
                  challenges with ethical confidence.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground/60 max-w-2xl mx-auto">
              Four pillars that drive our mission to develop exceptional HR leaders.
            </p>
          </div>
